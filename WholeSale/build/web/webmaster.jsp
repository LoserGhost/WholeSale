...
<%-- 
    Document   : webmaster
    Created on : Apr 14, 2016, 8:44:02 PM
    Author     : LoserGhost
--%>
        ...
        <div class="center">
            ...
            <div class="dropdown">
                ...
                <div class="dropdown-content">
                    <a href="webmaster.jsp?link=view" style="background-color: #cccccc">จัดการผู้ใช้</a>
                    <a href="webmaster.jsp?link=report" style="background-color: #f1f1f1">จัดการคำร้อง</a>
                </div>
            </div>
                    ...
                    <form action="ViewReport">
                        <table border="1" style="margin: auto">
                            ...
                            <c:forEach var="row" items="${result.rows}">
                                ...
                                <input type="hidden" name="who" value="web"/>
                            </c:forEach>
                        </table>
                    </form>
                </div>
